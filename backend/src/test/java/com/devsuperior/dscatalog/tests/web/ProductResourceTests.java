...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		invalidProductDTO = ProductFactory.createInvalidProductDTO(invalidPrice);
	...
	@Test
	public void updateShouldRetunProductDTOWhenIdExists() throws Exception {
		String accessToken = obtainAccessToken(operatorUsername, operatorPassword);
		String jsonBody = objectMapper.writeValueAsString(newProductDTO);
	...
	@Test
	public void updateShouldRetunNotFoundWhenIdDoesNotExist() throws Exception {
		String accessToken = obtainAccessToken(operatorUsername, operatorPassword);
		String jsonBody = objectMapper.writeValueAsString(newProductDTO);
		ResultActions result = 
